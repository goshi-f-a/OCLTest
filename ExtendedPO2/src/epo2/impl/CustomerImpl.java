 ...
 * </p>
 * <ul>
 *   <li>{@link epo2.impl.CustomerImpl#getCustomerID <em>Customer ID</em>}</li>
 *   <li>{@link epo2.impl.CustomerImpl#getOrders <em>Orders</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomerImpl extends MinimalEObjectImpl.Container implements Customer {
	...
	public EList<PurchaseOrder> getOrders() {
		if (orders == null) {
			orders = new EObjectWithInverseResolvingEList<PurchaseOrder>(PurchaseOrder.class, this, Epo2Package.CUSTOMER__ORDERS, Epo2Package.PURCHASE_ORDER__CUSTOMER);
		}
		return orders;
	}
